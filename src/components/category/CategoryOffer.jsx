              ...
              {couponData.map((offer, index) => (
                ...
                >
                  ...
                  <div onClick={(e) => handleOfferClick(e, offer)}
                    className=" cursor-pointer bg-white box-shadow-all rounded-tl-xl rounded-tr-xl flex flex-col items-center justify-between p-5 sm:p-6 h-[220px] sm:h-[260px] hover:shadow-xl transition-all duration-300">
